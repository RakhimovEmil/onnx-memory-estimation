...
class Graph:
    ...
    def find_optimal_strategy(self, max_batch_params: Dict[str, int], logs_enabled: bool = False, time_limit: int = 18000) -> List[MutableTensorInfo]:
        ...
        alap = get_nodes_alap(self.storage.nodes, self.storage.edges, max_asap)
